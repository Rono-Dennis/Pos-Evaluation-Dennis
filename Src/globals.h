...
int fncReadStaticDatafile(void);
void fncUpdateStaticData(void);
int fncReadAnyConfigFile(char * tcReadConfFile, char * FileContent);
int fncIncreaseSTAN(void);
void fncAddStan(void);
...
enum
{
	...
	appTerminalPin,			// default pin
	appTerminalPin2,		// new terminal pin set by agent
	appTerminalUser,		// terminal user
	appLocation,
	...
	appContact,
	appUsername,
	appRevenueItemAmount,
	appRevenueItemName,
	appHeaderDeposit,
	appHeaderWithdrawal,
	appHeaderBalance,
	appHeaderDeposit1,
	appHeaderWithdrawal1,
	appHeaderBalance1,
	appAppLoggedName,
	appAppLoggedName2,
	appAppVersionNumber,
...
enum {
	...
	mnuRevCollection,		//REVENUE COLLECTION
	...
	mnuAgencyReversal,		//AGENCY REVERSAL
	mnuLogOn,                // LOG ON
	...
	mnuCashDeposit,       	// cash deposit
	mnuCashWithdrawal,   	// cash withdrawal
	mnuBalanceInquiry,   	// balance inquiry
	mnuUtilityPayments,   	// utility payments
	mnuCardless,      		// cardlless transactions
	mnuReporting,     		//reporting
	mnuAgency ,      		//Agency
	mnuRevenue,      		//Revenue Collection
	mnuRev,
	mnuRecurrent,
	mnuFixed,
	mnuCashier,
	...
	mnuSuperv,
	mnuAdm,
	mnuAccountBalance,  	// account balance
	mnuMiniiStatement,    	//mini statement
	mnuWater,     			// paying water
	mnuElectricity,   		//paying electricity
	mnuDSTV,   				//Paying DSTV
	mnuZuku,    			//paying zuku
	mnuItax,    			// pay itax
	mnuServiceCodes,   		// paying service codes
	mnuLogIn,               // log in
	mnuDepo2Account, 		// cardless for depositing to the account
	mnuUtilityPayCardless,   // cardless payment for utility payment
	mnu3rdPartyServiceLookUp, // Cardless pay for third party service look up
	...
	mnuSupervisor,
	mnuUserManage,    // user management in supervisor
	mnuReports,          // reporting
	mnuSettlem,         // settlement
	...
	mnuCashWithdarwal,
	mnuCashDeposit1,
	mnuThirdPartyDeposit,
	mnuBalanceEnquiry,       // BALANCE ENQUIRY
	mnuAgentBalanceEnquiry,
	mnuBalanceEnquiry1,
	mnuCallNetserver,
	mnuNetserverSetup,
	mnuSupervisor1,
	mnuAdministrator,
	mnuCashValidateDeposit,
	mnuCashSubmit,
	mnuCardlessCashDeposit,


	mnuNetConfig,
	mnuTerminalInfor,
	mnuPrintConfigs,
	mnuRequestForServices, // Request for services
	mnuPaperRolls,			//Paper rolls
	mnuTraining,			//Request Training
	mnuServiceCard,			//Service cards
	mnuReportErrors,		//Report Errors
	mnuReportFraud,			//Report Fraud
	mnuSupervisorSupport, //Suoervisor support

	mnuNetConfigCustomer,
	mnuCallNetserverCustomer,
	mnuNetserverSetupCustomer,
	mnuSupportCustomer,
	mnuRequestForServicesCustomer,
	mnuPaperRollsCustomer,
	mnuTrainingCustomer,
	mnuServiceCardCustomer,
	mnuReportErrorsCustomer,
	mnuReportFraudCustomer,


	mnuNetConfigSupervisor,
	mnuCallNetserverSupervisor,
	mnuNetserverSetupSupervisor,

	mnuNetConfigAdmin,
	mnuCallNetserverAdmin,
	mnuNetserverSetupAdmin,
	mnuAdminHide,
	mnuManageUsers,
	mnuMesh,
	mnuAlt,
...
enum {
	...
	traPan2,                                    // pan for the utility account being paid to
	traResponse,                                // response to display during login
	traAgentUserName,
	traAgentPass,
	traFld72,                                    // for field 72 response
	traRevenueItems,							// storing all revenue items sent by gateway on field 62
	traRevGroup,
	traUserRole,
	traCreateUser,									// for creating user
	traCustomerId,                              // customer id
	traRevenueLocationCode,
	traLoginCode,				// login response code
	traLoginMessage,			//	"		"		message
	traLoginMDAPaymentAccount,			//	"		"		payment account
	traLoginMinistry,			//	"		"		ministry name
	traLoginAttendant,			//	"		"		name of person who logged in
	traLoginAttendantID,			//	"		"	ID "	"	"
	traLoginAttendantPhoneNo,			//	"		"PHONE NO "	"	"
	traLoginRole,			//	"		"		role of the person who logged in
	traUtilityServiceNo,                        // Utility service no
	traRevenueItemID,
	traRevenueItemID1,
	traRevenueItemAction,
	traRevenueItemActionStatus,
	traRevenueItemIntrash,
	traRevenueItemParentId,
	traRevenueItemCategory,
	traRevenueItemStream,
	traRevenueItemPaymentAccount,
	traDepositAcc,
	traRevenueItemBranchCode,
	traRevenueItemBranchName,
	traRevenueItemGeoCode,
	traRevenueItemGeoName,
	traComplaintNature,
	traComplaintsNaturesFLD72,						// list of nature of complaints on fild72
	traAgentPin,									// agent pin
	traPassword,
	traUserName,
	traSubCounty,
	traCountyCode,
	...
	traFname,
	traEmail,
	traUserDetails,									// user details
	traUsername,									// username
	traChangePasswordDetails,						// changing password
	traSupportComplaint,
	traRevItemDetailsByCode,
	traParkingDetails,
	traParkingDataResponse,
	traParkingData,
	traRevenueItemCharge,
	traParkingRequest,
	traRevenueWorkGroup,
	traZones,
	traAccountDetails,
	...
	traTranDoneByCard,
	traTranDoneAll,
	traAmountTotalByCard,
	traAmountTotalByCash,
	traPAAccount,
	traPAName,
	traPDurations,
	traPDuration,
	...
	traRolee,
	traPaymentMode,
	traRevenueStreamID,							// revenue stream ID
	traRevenueStreamName,					    // Revenue Stream Name
	traRevenueItemAmount,
	traRevenueItemName,
	traRevItemNoOfLevels,
	traSettlementDetails,
	traRevenueItemUniqueId,
	traRevenueItemText,
	traRevenueItemNickName,
	traRevenueItemIsParent,
	traCreteriaNo,
	traRatePayerCategoryRequest,
	traRevItemChildren,
	traRevenueBreakDown,
	traRevenueCriteria1,
	traRevenueCriteria2,
	...
	traRevenueCriteria4,
	traRevenueCriteria5,
	traRatePayerCategorys,
	traRatePayerCategoryName,
	traRatePayerCategoryCode,
	traRatePayerCategoryId,
	traOther,
	traRevenueItemNamee,
	traServicePaid,
	traRevenueCriteria6,
	...
	traCreteriaID26,
	traCreteriaID27,
	traZoneIDRevItemIDResponse,
	traComplainCode,
	traPayeeDetails,
	traRemedialAction,
	traHasNextChildDetails,
	traHasNextChildName,
	traHasNextChildStatus,
	traNextChildResponse,
	traNextChildResponsee,
	traRemedialActionResponse,
	traSupportNatureID,
	traSupportNature,
	traFeedbackDetails,
	traComplainCodeResponse,
	traChildren,
	traComplainCode11,
	traComplainCode12,
	traComplainCode13,
	traAllDetails,
	traValidationDetails,						//Acc validation for cardless
	traBusinessName,							//Business name
	traRevenueItemIDandZoneID,
	traTerminalSerialNumber,					// terminal serial number
	traAgentFloatBalance,						// floatbalance
	...
	traExpDatFormat,							 // Current Value Buffer for expiry date but formatted
	...
	traRevenueStreams,
	traRevenueStreams72,
	traRevenuePaymentAccount,
	traRevenueLocation,
	traConfirmPayment,
	traRevenueChargeDurationName,
	traRevenueChargeDurationId,
	traRevStreams,
	traOption,
	traReqRevItems,
	traAdmSecretPin,
	traAgentAccountNumber,
	traName,
	traAllTransactionData,
	traPDurationName,
	traIdNo,
	traContact,
	traRevenueCounty,
...
int incCardSTAN(word key); //TODO: VALENTINE STAN increment
...
int ApplicationReversal(char * Auth_Rsp);
...
int Application_reversal(void);
int Application_refund(void);
